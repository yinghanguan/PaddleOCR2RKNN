...
class det_rec_functions(object):
    ...
    def __init__(self, image, use_large=False):
        self.img = image.copy()
        self.det_file = r'E:\vs\chineseocr_lite-onnx\处理模型\det_sim.onnx'
        self.small_rec_file = r'E:\vs\chineseocr_lite-onnx\处理模型\rec_sim.onnx'
    ...
    def get_boxes(self):
        ...
        img_parts = np.transpose(img_part, (0, 2, 3, 1))
        np.save(r'./det_time_in0.npy', img_parts)
    ...
    def get_img_res(self, onnx_model, img, process_op):
        ...
        np.save(r'./rec_time_in0.npy', imgs)
...
if __name__=='__main__':
    # 读取图片
    image = cv2.imread(r'test_imgs/1.jpg')
    # OCR-检测-识别
